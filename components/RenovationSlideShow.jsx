                    ...
                    >
                        ...
                        <div className="flex flex-col justify-center items-center p-2 md:p-5">
                            ...
                            <img
                                ...
                                alt="before"
                                className={`rounded-xl object-contain ${isImageLandscape(urlFor(pair.before).url()) ? "max-w-full h-auto md:max-w-[600px] lg:max-w-[800px]" : " max-h-[400px] flex-1  md:max-h-[600px] lg:max-h-[800px]"}`}
                            />
                        </div>
                        <div className="flex flex-col justify-center items-center p-2 md:p-5">
